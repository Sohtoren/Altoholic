    ...
    public class FramerKitStorage(int size = 0)
    {
        ...
        public void Init(ClientLanguage currentLocale)
        {
            foreach (uint framerKitsId in _framerKitsIds)
            {
                ...
                Plugin.Log.Info($"ItemId: {item.RowId} KitId: {item.AdditionalData}");
