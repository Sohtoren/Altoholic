    ...
    public abstract class Database
    {
        ...
        public static void CheckOrCreateDatabases(Plugin plugin, SqliteConnection db)
        {
            ...
            else
            {
                ...
                if (!DoesColumnExist(plugin, db, CharacterTableName, "OccultCrescent"))
                {
                    Utils.LogMessage(LogLevel.Debug, plugin.Configuration.EnableDebugMessages, $"Column {CharacterTableName}.OccultCrescent does not exist");
                    const string sql38 = $"ALTER TABLE {CharacterTableName} ADD COLUMN OccultCrescent TEXT";
        ...
        private static Character FormatDatabaseCharacterFromDatabase(Plugin plugin, DatabaseCharacter databaseCharacter)
        {
            ...
            OccultCrescent? occultCrescent = string.IsNullOrEmpty(databaseCharacter.OccultCrescent)
                ? null
            ...
            return new Character()
            {
                ...
                UnlockedRoulettes = unlockedRoulettes,
        ...
        private static DatabaseCharacter FormatCharacterForDatabase(Character character, bool updateLastOnline = true)
        {
            ...
            string unlockedRoulettes = System.Text.Json.JsonSerializer.Serialize(character.UnlockedRoulettes);
