...
public class InventoriesWindow : Window, IDisposable
{
    ...
    private void DrawCrystals(Character selectedCharacter)
    {
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60651), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60652), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60653), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60654), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60655), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
        ...
        Utils.DrawIcon_test(_globalCache.IconStorage.LoadIcon(60656), new Vector2(24, 24));
        ImGui.TableSetColumnIndex(1);
