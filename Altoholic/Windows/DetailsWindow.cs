    ...
    public class DetailsWindow : Window, IDisposable
    {
        ...
        private string GetHouseTerritoryString(uint territoryId, int division)
        {
            return territoryId switch
            {
                ...
                608 => (division == 2) ? _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1806) : _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1812), //"Topmast Apartment",
                ...
                609 => (division == 2) ? _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1808) : _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1814), //"Lily Hills Apartment",
                ...
                610 => (division ==2) ? _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1191) : _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1816), //"Sultana's Breath Apartment",
                ...
                655 => (division == 2) ? _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 1921) : _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 2273), //"Kobai Goten Apartment",
                ...
                999 => (division == 2) ? _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 3726) : _globalCache.PlaceNameStorage.GetPlaceNameOnly(_currentLocale, 3695), //"Ingleside Apartment",
